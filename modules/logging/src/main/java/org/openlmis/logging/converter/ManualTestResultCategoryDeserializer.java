...
import org.openlmis.report.model.dto.ManualTestResultCategory;
import org.springframework.stereotype.Component;

@Component
public class ManualTestResultCategoryDeserializer extends EntityDeserializer<ManualTestResultCategory> {


    @Override
    public void createEntity() {
        super.setBaseModel(new ManualTestResultCategory());
    }
