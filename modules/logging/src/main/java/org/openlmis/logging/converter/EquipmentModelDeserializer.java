...
import org.openlmis.report.model.dto.EquipmentModel;
import org.springframework.stereotype.Component;

@Component
public class EquipmentModelDeserializer extends EntityDeserializer<EquipmentModel> {


    @Override
    public void createEntity() {
        super.setBaseModel(new EquipmentModel());
    }
