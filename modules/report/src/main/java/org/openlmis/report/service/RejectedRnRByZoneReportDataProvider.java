...
@Service
@NoArgsConstructor
public class RejectedRnRByZoneReportDataProvider extends ReportDataProvider{
    ...
    public List<? extends ResultRow> getReportBody(Map<String, String[]> filterCriteria, Map<String, String[]> sortCriteria, int page, int pageSize) {
        ...
        return reportMapper.getRejectionByZone(getReportFilterData(filterCriteria), sortCriteria, rowBounds, this.getUserId());
    }
