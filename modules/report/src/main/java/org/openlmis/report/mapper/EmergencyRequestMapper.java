...
public interface EmergencyRequestMapper {
    ...
    @SelectProvider(type = EmergencyRequestQueryBuilder.class, method = "getQuery")
    @Options(resultSetType = ResultSetType.SCROLL_SENSITIVE, fetchSize = 10, timeout = 0, useCache = true, flushCache = true)

    List<EmergencyRequistionReport> getEmergencyRequisitions(@Param("filterCriteria") NonReportingFacilityParam params,
