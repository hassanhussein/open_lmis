...
import org.openlmis.report.builder.QuantificationExtractHomeFacilityQueryBuilder;
...
@Repository
public interface QuantificationExtractHomeFacilityReportMapper {

    @SelectProvider(type= QuantificationExtractHomeFacilityQueryBuilder.class, method="getReportQuery")
    ...
    @SelectProvider(type= QuantificationExtractHomeFacilityQueryBuilder.class, method="getTotalNumberOfRowsQuery")
    @Options(resultSetType = ResultSetType.SCROLL_SENSITIVE, fetchSize=10,timeout=0,useCache=true,flushCache=true)
