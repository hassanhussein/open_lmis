...
import org.openlmis.report.mapper.QuantificationExtractHomeFacilityReportMapper;
...
@Service
@NoArgsConstructor
public class QuantificationExtractHomeFacilityReportServiceDataProvider extends ReportDataProvider {

    @Value("${report.status.considered.accepted}")
    private String configuredAcceptedRnrStatuses;

    @Autowired
    private QuantificationExtractHomeFacilityReportMapper reportMapper;
