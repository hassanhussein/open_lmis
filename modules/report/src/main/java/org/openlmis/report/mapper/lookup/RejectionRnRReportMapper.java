...
public interface RejectionRnRReportMapper {
    ...
    @Select("    select reason,facilityName,districtId,district_name districtName,region_name as regionName,zone_name as zoneName, to_char(createdDate, 'yyyy_mm') as Month, count(*) rejectedCount from ( \n" +
            "\n" +
            ...
            "                \n" +
            "                ) a\n" +
            "                group by facilityName,districtId, a.district_name,a.region_name, a.zone_name,reason, to_char(createdDate, 'yyyy_mm')\n" +
