...
public class FacilityController extends BaseController {
    ...
    @RequestMapping(value = "/searchVaccineStores/{searchParam}", method = GET, headers = ACCEPT_JSON)
    public ResponseEntity<OpenLmisResponse> searchVaccineStores(@PathVariable(value = "searchParam") String searchParam) {
