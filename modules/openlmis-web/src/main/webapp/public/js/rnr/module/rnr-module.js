...
var rnrModule = angular.module('rnr', ['openlmis', 'ngGrid', 'ui.bootstrap.modal', 'ui.bootstrap.dropdownToggle','tree.dropdown',
    'ui.bootstrap.dialog', 'angular.filter', 'isteven-multi-select']).config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when('/init-rnr', {
        controller: InitiateRnrController,
        templateUrl: 'partials/create/init.html',
        resolve: InitiateRnrController.resolve
    }).when('/create-rnr/:rnr/:facility/:program', {
        controller: CreateRequisitionController,
        templateUrl: 'partials/create/index.html',
        resolve: CreateRequisitionController.resolve,
        ...
        reloadOnSearch: false
    }).when('/view-requisition-via/:rnr/:program', {
        controller: ViewRnrViaDetailController,
        templateUrl: 'partials/view/rnr-via-view.html',
        reloadOnSearch: false
    }).when('/view-requisition-mmia/:rnr/:program', {
        controller: ViewRnrMmiaController,
        templateUrl: 'partials/view/rnr-mmia-view.html',
        reloadOnSearch: false
    }).when('/search-requisitions', {
        controller: SearchRnrListController,
        templateUrl: 'partials/view/search-requisition.html',
        resolve: SearchRnrListController.resolve
