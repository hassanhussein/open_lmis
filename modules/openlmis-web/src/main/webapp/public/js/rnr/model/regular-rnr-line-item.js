...
//TODO : Does not belong to RnrLineItem
  ...
  validateStockoutDays : function() {
    return ( (!_.isNumber(this.stockOutDays) && !_.isNumber(this.stockInHand) ) || (!_.isNumber(this.stockOutDays) && _.isNumber(this.stockInHand) && this.stockInHand > 0) || ((this.daysInPeriod >= this.stockOutDays) && (this.stockInHand > 0 || this.stockOutDays > 0)) );
  },
