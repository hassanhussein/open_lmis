...
function SearchRnrListController($scope, facilities, RequisitionsForViewing, ProgramsToViewRequisitions, $location, messageService, navigateBackService, FeatureToggleService) {
    ...
    function redirectBasedOnFeatureToggle() {
        var url = "requisition-data-health-check/";
