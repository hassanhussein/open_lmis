...
function ViewOrderListController($scope, Orders, messageService, $location, $routeParams, supplylines, programs, schedules, years, ReportPeriodsByScheduleAndYear, ReportProgramSchedules) {
    ...
    function refreshGrid() {
        ...
        Orders.get({
            ...
            $scope.filteredOrders = data.orders || [];
    ...
    $scope.filterOrders = function () {
        ...
        $scope.filteredOrders = $.grep($scope.orders, function (o) {
            return contains(o.status, query) ||
                contains(o.rnr.facilityCode, query) ||
                contains(o.rnr.facilityName, query) ||
                contains(o.rnr.districtName, query) ;
        });
