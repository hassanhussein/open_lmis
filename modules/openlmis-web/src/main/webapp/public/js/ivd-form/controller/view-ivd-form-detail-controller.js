 ...
 */
function ViewIvdFormDetailController($scope, $location, $window,isZnz, report, discardingReasons, operationalStatuses, ColdTraceStatus, ColdTraceAlarms, ColdTraceToken,Settings) {
