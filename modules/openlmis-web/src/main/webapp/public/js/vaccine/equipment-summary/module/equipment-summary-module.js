...
var app  = angular.module('equipment-summary', ['openlmis','ui.router', 'ngGrid', 'ui.bootstrap.dialog', 'ui.bootstrap.accordion',
    ...
    var states = [
        {
            ...
            controller:EquipmentSummaryControllerFunc,
            resolve:EquipmentSummaryControllerFunc.resolve,
            ncyBreadcrumb: {
                label: 'My Equipment Summary'
            }
        }/*,
        {
            name: 'element',
