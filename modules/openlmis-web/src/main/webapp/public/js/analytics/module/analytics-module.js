...
var app  = angular.module('analytics1', ['openlmis','ui.router','leaflet-directive', 'ngGrid', 'ui.bootstrap.dialog', 'ui.bootstrap.accordion',
    ...
    var states = [
        {
            ...
            controller:AnalyticsFunctionZm1,
            resolve:AnalyticsFunctionZm1.resolve,
            ncyBreadcrumb: {
