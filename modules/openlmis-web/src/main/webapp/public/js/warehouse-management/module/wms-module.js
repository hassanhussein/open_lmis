 ...
 */
var wmsModule = angular.module('wms', ['openlmis', 'ngTable',  'ui.chart', 'angularCombine' ,'ui.bootstrap', 'nsPopover', 'textAngular','lr.upload','ngFileUpload','angularFileUpload']).
config(['$routeProvider', function ($routeProvider) {
        $routeProvider.
            ...
            otherwise({redirectTo:'/list'});
             ...
             $rootScope.wmsSelected = "selected";
