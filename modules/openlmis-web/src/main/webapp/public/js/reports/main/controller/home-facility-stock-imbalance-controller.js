 ...
 */
function HomeFacilityStockImbalanceController($scope, $window, $routeParams, StockImbalanceHomeFacilityReport, $filter, $q, ngTableParams) {
    ...
    $scope.allPrinting = function(params) {
        ...
        StockImbalanceHomeFacilityReport.get(params, function(data) {
