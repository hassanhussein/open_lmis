...
var app  = angular.module('aggregate_order_fill_rate', ['openlmis','ui.router', 'ngGrid', 'ui.bootstrap.dialog', 'ui.bootstrap.accordion',
    ...
    var states = [
        {
            ...
            controller:OrderFillRateControllerFunc,
            resolve:OrderFillRateControllerFunc.resolve,
            ncyBreadcrumb: {
                label: 'Aggregate Order Fill Rate'
            }
        },
