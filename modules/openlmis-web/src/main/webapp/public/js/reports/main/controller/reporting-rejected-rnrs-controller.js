 ...
 */
function ReportingRejectedRnrController($scope, DetailRejectedRnRReport) {

  $scope.OnFilterChanged = function () {
    // clear old data if there was any
    $scope.data = $scope.datarows = [];
    $scope.filter.max = 10000;
      $scope.filter.status = 'INITIATED';
  ...
  $scope.exportReport = function (type) {
    ...
    var url = '/reports/download/detail-rejected-rnrs/' + type + '?reportingStatus=true&' + paramString;
