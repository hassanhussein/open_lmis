 ...
 */
function ReportingEmergency($scope, EmergencyRequests) {
  ...
  $scope.OnFilterChanged = function () {
    ...
    $scope.updateFacilityList = function () {
          ...
          $scope.data = $scope.responseData.pages.rows;
    ...
    EmergencyRequests.get($scope.getSanitizedParameter(), function (data) {
  ...
  $scope.exportReport = function (type) {
    ...
    var url = '/reports/download/reporting_emergency_request/' + type + '?reportingStatus=true&' + paramString;
