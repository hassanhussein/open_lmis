...
var app  = angular.module('aggregate_stock_status', ['openlmis','ui.router', 'ngGrid', 'ui.bootstrap.dialog', 'ui.bootstrap.accordion',
    ...
    var states = [
        {
            ...
            controller:AggregateStockStatusReportFunction,
            resolve:AggregateStockStatusReportFunction.resolve,
            ncyBreadcrumb: {
                label: 'Aggregate Stock Status'
            }
        },
