...
function ReportMessageController($scope, SendMessagesReportAttachment, GetFacilitySupervisors, SettingsByKey,
                                 ContactList, SendMessages, ReportingFacilityList, NonReportingFacilityList,
                                 messageService) {
