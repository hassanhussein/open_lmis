...
var locationModule = angular.module('location', ['openlmis', 'ui.bootstrap.modal','leaflet-directive', 'ui.bootstrap.dialog', 'ui.bootstrap.dropdownToggle', 'ui.bootstrap.pagination', 'ngDraggable']).
    config(['$routeProvider', function ($routeProvider) {
      $routeProvider.
          when('/search', {controller: LocationSearchController, templateUrl: 'partials/search.html', reloadOnSearch: false}).
          when('/create-location', {controller: LocationController, templateUrl: 'partials/create.html', resolve: LocationController.resolve}).
