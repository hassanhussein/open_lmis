...
var app  = angular.module('invoice_notification', ['openlmis','ui.router', 'ngGrid', 'ui.bootstrap.dialog', 'ui.bootstrap.accordion',
    ...
    var states = [
        {
            ...
            controller:InvoiceNotificationFunc,
            resolve:InvoiceNotificationFunc.resolve,
            ncyBreadcrumb: {
                label: 'MSD Out of stock notification report'
            }
        },

        {
         ...
         controller: 'InvoiceNotificationDetailFunc',
         ncyBreadcrumb: {
         //label: 'Stock Notification for {{productName}} in {{facilityName}} Store'
         label: 'Stock Notification for ',
                                   parent: 'home'
         }
         }
