...
@Controller
public class RegimenTransactionController extends BaseController {
  ...
  registerTransaction(@RequestBody List<RegimenDispatchTransaction> transactions) {
    transactions.forEach(RegimenDispatchTransaction::validate);
    transactions.forEach(t -> repository.insert(t));
    return transactions;
  }
