...
public interface IvdFormMapper {
   ...
   /* @Insert("INSERT INTO requisition_groups" +
    ...
    @Results(value = {
            ...
            @Result(property = "pmtctLineItems", javaType = List.class, column = "id",
                    many = @Many(select = "org.openlmis.ivdform.repository.mapper.reports.PmctcLineItemMapper.getLineItems")),

            @Result(property = "childVisitLineItems", javaType = List.class, column = "id",
                    many = @Many(select = "org.openlmis.ivdform.repository.mapper.reports.ChildVisitLineItemMapper.getLineItems")),

            @Result(property = "llInLineItemLists", javaType = List.class, column = "id",
                    many = @Many(select = "org.openlmis.ivdform.repository.mapper.reports.LLINMapper.getLineItems")),

            @Result(property = "ttStatusLineItems", javaType = List.class, column = "id",
                    many = @Many(select = "org.openlmis.ivdform.repository.mapper.reports.TtStatusLineItemMapper.getLineItems")),

            @Result(property = "breastFeedingLineItems", javaType = List.class, column = "id",
            ...
            @Result(property = "ctcLineItems", javaType = List.class, column = "id",
                    many = @Many(select = "org.openlmis.ivdform.repository.mapper.reports.CTCLineItemMapper.getLineItems"))
