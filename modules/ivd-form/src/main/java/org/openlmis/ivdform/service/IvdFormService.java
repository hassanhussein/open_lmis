...
import org.openlmis.ivdform.repository.*;
...
public class IvdFormService {
    ...
    @Autowired
    PmtctCategoryRepository pmtctCategoryRepository;

    @Autowired
    ChildVisitAgeGroupRepository visitAgeGroupRepository;

    @Autowired
    TtStatusCategoryRepository ttStatusCategoryRepository;

    @Autowired
    BreastFeedingAgeGroupRepository feedingAgeGroupRepository;

    @Autowired
    BreastFeedingCategoryRepository breastFeedingCategoryRepository;

    @Autowired
    WeightAgeRatioAgeGroupRepository ratioAgeGroupRepository;
    ...
    public VaccineReport createNewVaccineReport(Long facilityId, Long programId, Long periodId) {
        ...
        List<PmtctCategory> pmtctCategoryList = pmtctCategoryRepository.getAll();
        List<ChildVisitAgeGroup> childVisitAgeGroups = visitAgeGroupRepository.getAll();
        List<TtStatusCategory> ttStatusCategoryList = ttStatusCategoryRepository.getAll();

        List<BreastFeedingAgeGroup>breastFeedingAgeGroupList = feedingAgeGroupRepository.getAll();
        List<BreastFeedingCategory>breastFeedingCategoryList = breastFeedingCategoryRepository.getAll();

        List<WeightAgeRatioAgeGroup> weightAgeRatioAgeGroupList = ratioAgeGroupRepository.getAll();
        ...
        report.initializePmctLineItems(pmtctCategoryList, defaultFieldsToZero);

        report.initializeChildVisitLineItems(childVisitAgeGroups, defaultFieldsToZero);

        report.initializeLLINLineItems(defaultFieldsToZero);

        report.initializeTtStatusLineItems(ttStatusCategoryList, defaultFieldsToZero);

        report.initializeBreastFeedingLineItems(breastFeedingCategoryList,breastFeedingAgeGroupList,defaultFieldsToZero);
