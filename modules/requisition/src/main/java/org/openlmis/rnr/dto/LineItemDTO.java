...
import static org.openlmis.rnr.domain.ProgramRnrTemplate.QUANTITY_REQUESTED;
...
public class LineItemDTO extends RnrLineItem {
    ...
    public static final String DISPENSED_X_3 = "DISPENSED_X_3";
    ...
    private String remarksForTBDispensedQuantity;
    ...
    public void calculateMaxStockQuantity(ProgramRnrTemplate template) {
        ...
        } else if (CONSUMPTION_X_3.equalsIgnoreCase(columnOption)) {
            maxStockQuantity = this.normalizedConsumption * 3;
        } else if (DISPENSED_X_2.equalsIgnoreCase(columnOption)) {
            maxStockQuantity = this.quantityDispensed * 2;
        } else if (DISPENSED_X_3.equalsIgnoreCase(columnOption)) {
            maxStockQuantity = this.quantityDispensed * 3;
...
*/
    ...
    public void copyCreatorEditableFieldsForFullSupply(LineItemDTO lineItem, ProgramRnrTemplate template) {
    ...
    public void copyCreatorEditableFieldsForNonFullSupply(LineItemDTO lineItem, ProgramRnrTemplate template) {
    ...
    public void copyApproverEditableFields(LineItemDTO lineItem, ProgramRnrTemplate template) {
    ...
    private void copyField(String fieldName, LineItemDTO lineItem, ProgramRnrTemplate template) {
        if ((!template.columnsVisible(fieldName) || !template.columnsUserInput(fieldName)) && !(fieldName.equals(NEXT_MONTH_PATIENT) || fieldName.equals(DOSE_PER_MONTH)
                || fieldName.equals(QUANTITY_ISSUE) || fieldName.equals(QUANTITY_NEEDED_BY_HF) || fieldName.equals(TOTAL_REQUIREMENT))) {
            return;
        }
    ...
    private void copyTotalLossesAndAdjustments(LineItemDTO item, ProgramRnrTemplate template) {
