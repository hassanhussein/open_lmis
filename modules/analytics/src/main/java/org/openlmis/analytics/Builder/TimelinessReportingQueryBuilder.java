...
public class TimelinessReportingQueryBuilder {
  ...
  /*              "" +
                ...
                "                 FROM ( \n" +
                "                SELECT * , case when (select enablemonthlyreporting from programs where  id = '"+program+"'::int limit 1) then redesignreportingstatus else reportingstatus end as reporting\n" +
