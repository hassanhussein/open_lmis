...
--RHZE
update  program_products set patientcalculationformula='ADULT_NEW_INTENSIVE_PHASE'
where programid=(select id from programs where code='TB&LEPROSY') and productid=(select id from products where code='10010087AE')

--RH 150/75
update  program_products set patientcalculationformula='ADULT_NEW_CONTINUATION_PHASE'
where programid=(select id from programs where code='TB&LEPROSY') and productid=(select id from products where code='10010086AE')


--MB(Adult)
update  program_products set patientcalculationformula='MB_ADULT'
where programid=(select id from programs where code='TB&LEPROSY') and productid=(select id from products where code='10010110AE')

--MB(Pedriatics)
update  program_products set patientcalculationformula='MB_PEDIATRIC'
where programid=(select id from programs where code='TB&LEPROSY') and productid=(select id from products where code='10010113AE')

--PB(Adult)
update  program_products set patientcalculationformula='PB_ADULT'
where programid=(select id from programs where code='TB&LEPROSY') and productid=(select id from products where code='10010112AE')

--PB(Pedriatics)
update  program_products set patientcalculationformula='PB_PEDIATRIC'
where programid=(select id from programs where code='TB&LEPROSY') and productid=(select id from products where code='10010310AE')


--RHZ 75/50/150
update  program_products set patientcalculationformula='CHILD_NEW_INTENSIVE_PHASE'
where programid=(select id from programs where code='TB&LEPROSY') and productid=(select id from products where code='10010256AE')

--Ethambutol 100mg
update  program_products set patientcalculationformula='CHILD_NEW_INTENSIVE_PHASE'
where programid=(select id from programs where code='TB&LEPROSY') and productid=(select id from products where code='10020027AE')


--RH75/50
update  program_products set patientcalculationformula='CHILD_NEW_CONTINUATION_PHASE'
where programid=(select id from programs where code='TB&LEPROSY') and productid=(select id from products where code='10010255AE')

--Isonizid 100mg
update  program_products set patientcalculationformula='IPT_PEDIATRIC'
where programid=(select id from programs where code='TB&LEPROSY') and productid=(select id from products where code='10010114AE')

--Isonizid 300mg
update  program_products set patientcalculationformula='IPT_ADULT'
where programid=(select id from programs where code='TB&LEPROSY') and productid=(select id from products where code='10010089AE')
