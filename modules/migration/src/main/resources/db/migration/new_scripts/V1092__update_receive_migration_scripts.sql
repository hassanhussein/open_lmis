...
---------- receive_details ------------
CREATE TABLE receive_line_items (ID SERIAL PRIMARY KEY,
receiveid INTEGER,
productid INTEGER,
...
ALTER TABLE receive_line_items ADD CONSTRAINT receive_line_items_receives_fkey FOREIGN KEY (receiveid) REFERENCES receives (ID);

ALTER TABLE receive_line_items ADD CONSTRAINT receive_line_items_products_fkey FOREIGN KEY (productid) REFERENCES products (ID);


---------- receive_lots ------------
CREATE TABLE receive_lots (ID SERIAL PRIMARY KEY,
receivelineItemId INTEGER,
locationid INTEGER,
...
ALTER TABLE receive_lots ADD CONSTRAINT receive_lots_receive_receive_line_items_fkey FOREIGN KEY (receiveLineItemId) REFERENCES receive_line_items (ID);
...
ALTER TABLE receives DROP COLUMN IF EXISTS isforeignprocument;
ALTER TABLE receives DROP COLUMN IF EXISTS isforeignprocurement;
ALTER TABLE receives ADD COLUMN isforeignprocurement BOOLEAN Default False;