...
CREATE MATERIALIZED VIEW public.mv_dashboard_tracer_reported_products_by_programs AS
...
-- Index: public.i_mv_dashboard_tracer_reported_products_by_programs_productcode

-- DROP INDEX public.i_mv_dashboard_tracer_reported_products_by_programs_productcode;

CREATE INDEX i_mv_dashboard_tracer_reported_products_by_programs_productcode
  ON public.mv_dashboard_tracer_reported_products_by_programs
  USING btree
  (productcode COLLATE pg_catalog."default");

-- Index: public.i_mv_dashboard_tracer_reported_products_by_programs_productname

-- DROP INDEX public.i_mv_dashboard_tracer_reported_products_by_programs_productname;
