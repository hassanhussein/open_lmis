...
-- Index: public.mv_requisition_adjustment_index_product

DROP INDEX if exists public.mv_requisition_adjustment_index_product;

CREATE INDEX mv_requisition_adjustment_index_product
  ON public.mv_stock_imbalance_by_facility_report
  USING btree
  (product COLLATE pg_catalog."default");

-- Index: public.mv_stock_imbalance_by_facility_report_facility_code

DROP INDEX if exists public.mv_stock_imbalance_by_facility_report_facility_code;
...
-- Index: public.mv_stock_imbalance_by_facility_report_facility_code_productid

 DROP INDEX if exists public.mv_stock_imbalance_by_facility_report_facility_code_productid;
...
-- Index: public.mv_stock_imbalance_by_facility_report_facility_id

DROP INDEX if exists public.mv_stock_imbalance_by_facility_report_facility_id;
...
-- Index: public.mv_stock_imbalance_by_facility_report_periodid

DROP INDEX if exists public.mv_stock_imbalance_by_facility_report_periodid;
...
DROP INDEX if exists public.mv_stock_imbalance_by_facility_report_longitude;

CREATE INDEX mv_stock_imbalance_by_facility_report_longitude
  ON public.mv_stock_imbalance_by_facility_report
  USING btree
  (LONGITUDE);
CREATE INDEX mv_stock_imbalance_by_facility_report_latitude
  ON public.mv_stock_imbalance_by_facility_report
  USING btree
  (LATITUDE);
