...
This is to inform you that {from_facility_name} has Issued Stock for the order that was requested on {date_submitted} for the Period {period} . Please make follow-up on consignment. Your voucher number is {voucher_number} .
{link}
