...
CREATE MATERIALIZED VIEW  mv_requisition_adjustment AS
...
DROP INDEX IF EXISTS mv_requisition_adjustment_index_id;
CREATE INDEX mv_requisition_adjustment_index_id
ON mv_requisition_adjustment
USING btree
(id);

DROP INDEX IF EXISTS mv_requisition_adjustment_index_facility_code;
...
DROP INDEX IF EXISTS mv_requisition_adjustment_index_productcode;
...
DROP INDEX IF EXISTS mv_requisition_adjustment_index_supplying_facility_name;
