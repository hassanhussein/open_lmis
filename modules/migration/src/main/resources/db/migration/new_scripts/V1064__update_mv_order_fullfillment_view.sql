...
AS
 SELECT shipment_line_items.orderid,
    ...
    shipment_line_items.packeddate,
    shipment_line_items.shippeddate
   FROM shipment_line_items
  GROUP BY shipment_line_items.orderid, shipment_line_items.productcode, shipment_line_items.shippeddate, shipment_line_items.packeddate
WITH DATA;
