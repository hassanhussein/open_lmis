...
ALTER TABLE receives
    ADD COLUMN receiveNumber character varying(250);
...
FOR select r.receiveNumber, r.id,r.note, r.description,r.blawbnumber, r.id receiveid, rli.productid, rli.quantitycounted,rl.boxNumber,rl.locationId, rli.boxcounted,r.invoiceNumber, t.id lotid, rl.lotnumber, rli.lotflag, rl.expirydate, rl.quantity
from receives r
