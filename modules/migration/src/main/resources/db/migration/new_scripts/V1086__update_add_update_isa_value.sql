...
DROP INDEX IF EXISTS i_program_product_isa_programProductId;
...
DROP FUNCTION IF EXISTS  fn_insert_isa(numeric, integer, numeric, numeric, integer, integer, integer, integer, timestamp without time zone, integer, timestamp without time zone, integer, integer);
