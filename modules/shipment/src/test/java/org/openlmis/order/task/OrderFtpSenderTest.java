...
public class OrderFtpSenderTest {
  ...
  public void shouldSendFileToFtpLocation() throws Exception {
    ...
    verify(producerTemplate).sendBodyAndHeader("ftps://username@serverhost:serverport/localfolderpath?password=password&passiveMode=true", file, Exchange.FILE_NAME, fileName);
  }
