...
public class ConfigurationSettingKey {
  ...
  public static final String EMAIL_TEMPLATE_FOR_REJECTED_REQUISITION = "EMAIL_TEMPLATE_FOR_REJECTED_REQUISITION";
  public static final String EMAIL_SUBJECT_FOR_REJECTED_REQUISITION = "EMAIL_SUBJECT_FOR_REJECTED_REQUISITION";
