...
public class BudgetLineItemRepositoryTest {
  ...
  public void shouldInsertBudgetLineItemIfDoesNotExistsAlready() throws Exception {
    ...
    BudgetLineItem budgetLineItem = new BudgetLineItem(1L, 2L, 1L, 1L, new Date(), BigDecimal.valueOf(345.45), "My good notes",true,"Dr");
  ...
  public void shouldUpdateBudgetLineItemIfAlreadyExists() throws Exception {
    Long periodId = 1l;
    BudgetLineItem budgetLineItem = new BudgetLineItem(1L, 2L, periodId, 1L, new Date(), BigDecimal.valueOf(345.45), "My good notes",true,"Dr");
