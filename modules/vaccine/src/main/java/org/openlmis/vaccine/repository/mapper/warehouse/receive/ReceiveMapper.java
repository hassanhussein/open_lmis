...
public interface ReceiveMapper {
 ...
 @Insert("INSERT INTO public.receives(\n" +
         ...
         "            isForeignProcurement,createdBy,createdDate,modifiedBy,modifiedDate,currencyId, invoiceNumber,receiveNumber)\n" +
         ...
         "            #{createdBy}, NOW(),#{modifiedBy},NOW(), #{currencyId}, #{invoiceNumber}, #{receiveNumber});")
  ...
  @Update(" UPDATE public.receives\n" +
          ...
          "       description=#{description}, isForeignProcurement=#{isForeignProcurement}, modifiedBy=#{modifiedBy}, modifiedDate=NOW(), currencyId=#{currencyId}, invoiceNumber=#{invoiceNumber}, receiveNumber=#{receiveNumber}\n" +
          " WHERE id = #{id}")
...
*/
    ...
    @Select("SELECT receiveNumber from receive_line_Items where receiveNumber is not null order by id desc limit 1")
